            ...
            <div>
                {
                    !this.props.currentLocation.isFetchingCurrentLocation ? (
                        <div>
                            <PlaceNameComponent address={this.props.currentLocation.currentLocationData.city.length > 0 ? this.props.currentLocation.currentLocationData.city : this.props.currentLocation.currentLocationData.country_name} />
